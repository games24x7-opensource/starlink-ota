...
function startMasterMetricsServer() {
    ...
    metricsServer.get("/clusterMetrics", (req, res) => __awaiter(this, void 0, void 0, function* () {
        try {
            const [workerMetrics, masterMetrics] = yield Promise.all([aggregatorRegistry.clusterMetrics(), masterRegistry.metrics()]);
