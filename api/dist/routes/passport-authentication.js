...
const passportBearer = __importStar(require("passport-http-bearer"));
const passportGitHub = __importStar(require("passport-github2"));
const passportWindowsLive = __importStar(require("passport-windowslive"));
